...
%% Circles in figures Appendix C1a, C1c
...
% This section generates the circles in figures C1a and C1c in the
% appendix.
...
%% Single ellipses in Appendix C.3(b) abnd (f)
...
% Ellipse in C.3(b) with angle of inclination 30 degrees, semi major axis 200
...
% Ellipse in C.3(f) with angle of inclination 30 degrees, semi major axis 200
...
%% Double ellipses in Appendix C.4b and C.4d, with Voronoi diagrams in Figure 10c and 10d
% Note that the rest of the ellipses in Figure C.4 can be easily generated
% by modifying the geometry in eList below.
